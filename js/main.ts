...
let author = document.querySelector("#autore")! as HTMLHeadingElement;

let form = document.querySelector("#form")! as HTMLFormElement; // Form d'inserimento città

let button = document.querySelector("#invia")! as HTMLButtonElement;
let testo = document.querySelector("#in-invia")! as HTMLDivElement;
let spinner = document.querySelector("#spinner")! as HTMLDivElement;

let reset = document.querySelector("#reset")! as HTMLButtonElement; // Pulsante reset

let input = document.querySelector("#city")! as HTMLInputElement; // Campo di input
// Alerts di errore
let avvertimento = document.querySelector("#avvertimento")! as HTMLDivElement;
let errore = document.querySelector("#errore")! as HTMLDivElement;

let pagina = document.querySelector("#pagina")! as HTMLDivElement; // Sezione principale che appare quando si fa una ricerca
...
function getWeather() {
    ...
    if (!cityName) {
        ...
        fetch(`https://api.openweathermap.org/data/2.5/forecast?q=${cityName}&appid=f49f974ab3536d74d780021f75e07be5`)
            ...
            .then(data => {
                ...
                let tempCelsius = (temp.temp - 273.15).toLocaleString("it-IT", { maximumFractionDigits: 1, minimumFractionDigits: 1 }); // Convertiamo la temperatura in Celsius e la arrotondiamo alla prima cifra decimale
